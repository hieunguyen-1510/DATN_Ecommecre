...
const kidsSubCategories = [
  {
    title: "Cute Sweaters",
    subtitle: "Warm and adorable",
    image: assets.kidsSweater,
    path: "/collection/kids/sweaters",
  },
  {
    title: "Kids Shorts",
    subtitle: "Comfortable and active",
    image: assets.kidsShorts,
    path: "/collection/kids/shorts",
  },
  {
    title: "Everyday Tees",
    subtitle: "Short & Long Sleeves",
    image: assets.kidsTshirt,
    path: "/collection/kids/tshirts",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-gray-50 py-4 px-4 sm:px-6 text-xs sm:text-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <span className="mx-2">/</span>
          <span className="font-medium text-gray-900">Trẻ em</span>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {kidsSubCategories.map((cat, index) => (
            <motion.div
              key={cat.title}
