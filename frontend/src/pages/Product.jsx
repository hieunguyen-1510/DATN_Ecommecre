    ...
    >
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row lg:gap-16 gap-8">
          ...
          >
            {/* Thumbnail Images */}
            <div className="flex lg:flex-col overflow-x-auto lg:overflow-y-auto justify-start lg:w-[18%] w-full gap-4 lg:gap-0 max-h-[600px] pr-1">
              {productData.image.map((img, index) => (
                <img
                  key={index}
                  src={img || "https://placehold.co/100x133/E0E0E0/6C6C6C?text=No+Image"}
            ...
            <div className="w-full lg:w-[80%] h-full aspect-[3/4]">
              <motion.img
                ...
                src={mainImage || "https://placehold.co/600x800/E0E0E0/6C6C6C?text=No+Image"}
          ...
          >
            <h1 className="font-black text-2xl text-gray-900 leading-tight">{productData.name}</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700 text-sm font-medium">(122 đánh giá)</span>
            </div>
            ...
            <p className="text-gray-700 leading-relaxed text-base">
              {productData.description || "Áo thun oversize giặt acid loang jổ, như bức tranh đường phố sống động. Thoải mái, nổi loạn - chuẩn gu Việt!"}
            </p>

            {/* Size Selection */}
            <div className="pt-4">
              <h3 className="font-bold text-gray-900 text-base mb-4">Chọn kích cỡ</h3>
        ...
        >
          <div className="flex border-b border-gray-200 overflow-x-auto scrollbar-hide">
            <button
              className={`px-8 py-4 font-semibold text-lg transition-colors duration-200 ${activeTab === "description"
            ...
            <button
              className={`px-8 py-4 font-semibold text-lg transition-colors duration-200 ${activeTab === "reviews"
                ? "text-yellow-600 border-b-2 border-yellow-500"
                : "text-gray-700 hover:text-yellow-500"
                }`}
        ...
        <motion.div
          variants={sectionVariants}
          className="mt-12 bg-white rounded-2xl shadow-xl p-8 space-y-3"
        >
