    ...
    >
      ...
      <Link to={`/product/${product._id}`} className="block">
        <div className="relative aspect-[3/4] overflow-hidden">
          <img
            src={product.image && product.image[0] ? product.image[0] : "https://placehold.co/600x800/E0E0E0/6C6C6C?text=No+Image"} // Thêm placeholder
      ...
      {/* Thêm padding cho phần nội dung text */}
      <div className="p-5 relative"> 
        <h3 className="text-gray-900 text-base font-bold mb-2 flex items-center justify-between"> 
          <Link to={`/product/${product._id}`} className="flex-1 overflow-hidden whitespace-nowrap text-ellipsis pr-2"> 
            {product.name}
          </Link>
          {/* Icon giỏ hàng - Đồng bộ màu sắc và hiệu ứng */}
          <button
        ...
        {showSizes && (
          <div className="absolute right-5 bottom-20 bg-white border border-gray-200 rounded-md shadow-lg z-20 py-1 min-w-[100px]"> {/* Điều chỉnh vị trí, thêm min-width */}
      ...
      {/* Border hiệu ứng hover - Đồng bộ với BestSeller */}
